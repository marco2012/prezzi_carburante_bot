...
bot.on("message", function (msg) {
  ...
  let msg_options = {
    reply_markup: JSON.stringify({
      inline_keyboard: [
        [
          { text: "⛽ Benzina", callback_data: `Benzina,${citta},${addr}` },
          {
            text: "⛽ Blue Super",
            callback_data: `Blue Super,${citta},${addr}`,
          },
        ],
        [
          { text: "⛽ Gasolio", callback_data: `Gasolio,${citta},${addr}` },
          {
            text: "⛽ Blue Diesel",
            callback_data: `Blue Diesel,${citta},${addr}`,
          },
        ],
        [
          { text: "⛽ GPL", callback_data: `GPL,${citta},${addr}` },
          { text: "⛽ Metano", callback_data: `Metano,${citta},${addr}` },
        ],
      ],
    }),
    parse_mode: "markdown",
        ...
        reply_markup: JSON.stringify({
          inline_keyboard: [
            [
              {
                text: "🗺️ Mappa",
                callback_data: "0," + row.Latitudine + "," + row.Longitudine,
              },
            ],
          ],
        }),
